...
// Color returns a random hexadecimal color.
...
// DomainSuffix returns a random domain suffix.
func (i *Internet) DomainSuffix() string {
	return i.pick(internetPrefix + "/domain_suffix")
}

// DomainWord returns a random domain word.
...
// Protocol Randomly returns http or https
...
// UserName returns a username based on one of several patterns
